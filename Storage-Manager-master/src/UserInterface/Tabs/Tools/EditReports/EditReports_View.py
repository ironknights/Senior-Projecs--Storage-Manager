...
# Class Definition ####################################################################################################
class EditReportsView(MainTabViewer):
    # Self Init
    ...
    def create_layout(self):
        ...
        layout = [
            ...
            [Gui.Button('Create New', key='_CREATE_NEW_')],
            [Gui.Tree(data=treedata, headings=[], auto_size_columns=True, num_rows=30, show_expanded=True,
                      col0_width=25, key='_EDIT_REPORT_OPTIONS_', enable_events=True, change_submits=True)]
        ]
